...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    */
    ...
    public function __construct()
    {
        ...
        // set default dirs
        $this->setTemplateDir('.' . DS . 'bbnt_archives' . DS . 'temas' . DS . TS_TEMA . DS)
            ->setCompileDir('.' . DS . 'bbnt_resource' . DS . 'ext' . DS . 'templates_c' . DS)
            ->setPluginsDir(SMARTY_PLUGINS_DIR)
            ->setCacheDir('.' . DS . 'bbnt_resource' . DS . 'ext' . DS . 'cache' . DS)
            ->setConfigDir('.' . DS . 'bbnt_resource' . DS . 'ext' . DS . 'configs' . DS);
