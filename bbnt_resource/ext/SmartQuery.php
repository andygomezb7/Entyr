...
function cleanRequest()
{
	...
	$scripturl = $babanta->settings['url'] . '/index.php';
    ...
    if((!empty($_SERVER["HTTP_REFERER"]) && (in_array($tsPage, array('admod/home', 'admode/home', 'cuenta')) || $_SERVER['QUERY_STRING'] == 'action=login-salir') && !$IsMySite) || $_SERVER["REQUEST_METHOD"] === "POST" && !$IsMySite) { die("Invalid request"); }
}
